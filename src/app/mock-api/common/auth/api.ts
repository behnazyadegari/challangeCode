    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                // Sign in successful
                if ( request.body.email === 'behnazyadegari@gmail.com' && request.body.password === 'Aadmin100' )
                {
                    return [
                        200,
                        {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                // Sign in successful
                if ( request.body.email === 'behnazyadegari@gmail.com' && request.body.password === 'admin' )
                {
                    return [
                        200,
                        {
